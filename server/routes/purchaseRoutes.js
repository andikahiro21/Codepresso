...
const { setDelivery, setOrderFinish, getSelectedPurchaseGroups, getPurchaseGroups, getPurchaseGroupsAdmin, getActivePurchaseGroups, getFinishedPurchaseGroups } = require("../controllers/purchaseController");
...
router.get("/purchase/finished-purchase", Authenticated, isDriver, getFinishedPurchaseGroups);
